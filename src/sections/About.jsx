...
const About = () => {
    return (
        <section
            id="about"
            className="text-white pb-24 max-w-full md:px-24"
        >
            <motion.h1
                ...
                viewport={{ once: true }}
                className="text-3xl md:text-6xl font-bold leading-snug text-gray-200 mr-2 mb-12 md:mb-24 text-justify max-w-full"
            >
